...
public class BaseScreen implements Screen, InputProcessor {
    ...
    public boolean touchDown(Vector2 touch, int pointer, int button) {
        System.out.println("touchDown touchX = " + this.touch.x + "touchY = " + this.touch.y);
        return false;
    }
    ...
    public boolean touchUp(Vector2 touch, int pointer, int button) {
        System.out.println("touchUp touchX = " + this.touch.x + "touchY = " + this.touch.y);
        return false;
    }
    ...
    public boolean touchDragged(Vector2 touch, int pointer) {
        System.out.println("touchDragged touchX = " + this.touch.x + "touchY = " + this.touch.y);
        return false;
    }
